...
$('logout').onclick=()=>{key='';current=null;signature='';guide=null;listMarkup='';rows=[];workers=[];$('detail').innerHTML='';$('guide-content').value='';$('guide-list').innerHTML='';$('list').innerHTML='';$('prompt').value='';$('chat-prompt').value='';$('app').hidden=true;$('login').hidden=false;notify('업무 공간을 잠갔습니다.')};
