...
| 1F 시설·보안층 | 전력, 냉방, 소방, 물리보안 | UPS·배터리·수랭식 냉동기·펌프, 출입·방재 설비 |
| 2F 일반 전산실 | 시스템, 스토리지, 네트워크, 보안 | FW·IPS·WAF, 업무 앱, 서버·디스크 조사 |
| 3F AI 전산실 | GPU 플랫폼, 추론 서비스, 모델 운영 | NVIDIA 7대, 플랫폼·설치 모델·Ollama 적재 상태 조회 |
| 4F 운영층 | NOC·SOC, 업무 조정, 검토·감사 | 역할별 근무석, 운영리드 전용 공간, AI 에이전트 관제 |
